...
def _package_error_response(package_id: str) -> web.Response | None:
    if not (package_id or "").strip():
        return web.Response(
            status=400,
            text="Не выбран пакет практик. Откройте страницу выбора пакета и выберите старт, полный маршрут, антистресс-систему или личный антистресс-месяц.",
    ...
    try:
        ...
        return web.Response(
            ...
            text=(
                ...
                "Откройте страницу выбора пакета и выберите старт, полный маршрут, антистресс-систему или личный антистресс-месяц."
            ),
            content_type="text/plain",
        )
    return None
