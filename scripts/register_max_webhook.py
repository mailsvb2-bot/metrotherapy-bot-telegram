...
"""Register and verify the MAX webhook subscription.

This ops helper is intentionally dependency-free so it can be run on the server
after deploying environment variables. It does not start the bot and it never
prints secrets.

Required env:
  MAX_BOT_TOKEN
  MAX_WEBHOOK_SECRET or MAX_SECRET_KEY
  MESSENGER_PUBLIC_BASE_URL

Example:
  APP_ENV=prod python scripts/register_max_webhook.py
"""
