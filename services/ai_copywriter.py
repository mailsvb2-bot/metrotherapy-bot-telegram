...
def generate_ab_texts(*, context: str, goal: str, tone: str = "уважительный, бережный") -> tuple[str, str]:
    ...
    system = (
        ...
        "Ваша задача — писать тексты автоворонки и админских маркетинговых сообщений. "
        "Не выступайте терапевтом, врачом или психологом. Не ставьте диагнозы, не обещайте лечение, "
        "исцеление или гарантированный терапевтический результат. "
        "Пишите уважительно, на 'Вы', без давления, короткими абзацами. "
        "Дайте два разных варианта текста (A и B)."
    )
    user = (
        f"Контекст продукта:\n{context}\n\n"
        f"Цель сообщения:\n{goal}\n\n"
