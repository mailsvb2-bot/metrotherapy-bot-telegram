...
def test_lts_uses_aiogram_bot_methods() -> None:
    text = _source()
...
def test_lts_defaults_to_no_send() -> None:
    text = _source()
...
def test_lts_records_probe_ledger() -> None:
    text = _source()
...
def test_lts_has_no_broad_exception_handlers() -> None:
