...
from services.messenger.audio_progress import record_audio_delivery, get_audio_item_by_anchor
...
def test_audio_timeline_records_issue_and_access(monkeypatch, tmp_path):
    ...
    assert 'access_confirmed' in names
