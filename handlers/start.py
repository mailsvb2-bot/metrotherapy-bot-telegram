...
HELP_TEXT = (
    ...
    "Не запускайте практику за рулём, при управлении транспортом или механизмами. "
    "Дождитесь безопасной остановки или слушайте как пассажир.\n\n"
    "Если во время практики становится хуже, остановите аудио. "
    "При остром или небезопасном состоянии обратитесь за живой профессиональной помощью.\n\n"
...
async def tariffs_cmd(message: Message):
    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="💳 Открыть пакеты практик", callback_data="sub:menu")],
    ...
    await message.answer(
        ...
        "Если уже готовы — выберите подходящий пакет практик.",
        reply_markup=kb,
    )
